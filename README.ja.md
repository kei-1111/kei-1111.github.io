> English version: [README.md](README.md) — 編集時は本ファイルと英語版を必ず同期させること。
...
詳細は以下を参照してください。
- [docs/ArchitectureOverview.ja.md](docs/ArchitectureOverview.ja.md)：アーキテクチャ・データフロー・DI・ナビゲーション
- [docs/ModuleOverview.ja.md](docs/ModuleOverview.ja.md)：モジュール構成と依存関係
