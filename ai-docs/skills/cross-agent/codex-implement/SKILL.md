...
7. **Report** — changed files, validation results, what Sol implemented vs. what the director fixed, and any deviation from the plan with its reason. Always also publish the report as an HTML Artifact.
