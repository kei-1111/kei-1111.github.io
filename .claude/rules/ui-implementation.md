...
- Reference: `feature/profile/.../destination/profile/ProfileScreen.kt` (both overloads, plus `LaunchedEffect(layout) { onIntent(UpdateLayout(layout)) }` on breakpoint change).
