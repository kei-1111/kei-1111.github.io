...
- Covers routing, the GitHub client, the TTL cache (single-flight / stale-if-error), and the shared-model JSON wire contract (`contract/SharedModelContractTest` — forward compatibility).
