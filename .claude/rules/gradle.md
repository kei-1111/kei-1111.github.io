...
./gradlew :app:feature:profile:testAndroidHostTest     # client unit tests, local JVM (CI runs these; also :app:core:domain / :app:core:mvi / :app:feature:splash)
