...
|-------------|---------|---------------|
| `template` | `io.github.kei_1111.template.{destination\|navigation}.{screen\|dialog}` | `io.github.kei_1111.template.destination.screen` |
