...
| `:app:core:local` | Local persistence layer. Access to the settings DataStore shared by theme and display language, with recovery on corruption | `.claude/rules/data-layer.md` |
